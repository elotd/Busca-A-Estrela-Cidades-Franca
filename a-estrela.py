...
AMI =  {"name":"AMI", "adj":["CAL", "LIL", "PAR", "CAE"], "dist":[122.14,95.68,117.89,207.91]}#AMI
CAE =  {"name":"CAE", "adj":["AMI", "PAR", "REN"], "dist":[207.91,201.85,152.58]}#CAE
MET =  {"name":"MET", "adj":["LIL", "PAR", "DIJ", "STR"], "dist":[280.15,279.86,214.9,129.82]}#MET
PAR = {"name":"PAR", "adj":["AMI", "LIL", "MET", "ORL", "CAE"], "dist":[117.89, 205.56, 279.86,107.5,201.85]}#PAR
...
LAR = {"name":"LAR", "adj":["NAN", "BOR"], "dist":[121.32,152.46]}#LAR
BOR = {"name":"BOR", "adj":["LAR", "STE", "TOU"], "dist":[152.46,395.48,211.43]}#BOR
STE = {"name":"STE", "adj":["BOR", "TOU", "LYO"], "dist":[395.48,314.15,49.67]}#STE
...
nodes = {"CAL": CAL, "LIL": LIL, "AMI": AMI,
"CAE": CAE, "MET": MET, "PAR": PAR, "REN": REN, "ORL": ORL, "STR":STR, "NAN":NAN,
"BOU":BOU, "DIJ": DIJ, "LAR":LAR, "BOR":BOR, "STE":STE,"LYO": LYO, "TOU":TOU,
"AVI":AVI,"NIC":NIC,"MAR":MAR}

heuristic = {"CAL":890.59, "LIL":832.45, "AMI":768.69, "CAE":787.53,"MET":649.03,"PAR":659.4,"REN":764.26,
...
origin = input("Type the origin: ") #CAL, LIL, ...
